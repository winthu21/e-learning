                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 offset-3">
                                <a class="small" href="<?php echo e(route('home')); ?>"><i class="fa-solid fa-backward"></i> Back</a>
                                <div class="p-5">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo e(route('registerPage')); ?>">Don't have an acoount? Create</a>
...
<?php /**PATH C:\xampp\htdocs\eduWeb\resources\views/guest/login.blade.php ENDPATH**/ ?>