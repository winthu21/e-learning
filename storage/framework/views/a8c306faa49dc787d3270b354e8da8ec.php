        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item mx-2">
                        <a class="nav-link <?php echo e(request()->routeIs('coursePage') ? 'active' : ''); ?>"
                            href="<?php echo e(route('coursePage')); ?>">Courses</a>
                    </li>
                    <li class="nav-item mx-2">
                    ...
                    <li class="nav-item mx-2">
                        <a class="nav-link <?php echo e(request()->routeIs('contactPage') ? 'active' : ''); ?>"
                            href="<?php echo e(route('contactPage')); ?>">Contact</a>
                    </li>
                </ul>
                <?php if(auth()->user() != null): ?>
                    <h4 class="me-3"><?php echo e(auth()->user()->name); ?></h4>
                    <form action="<?php echo e(route('logout')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="submit" class="btn btn-outline-danger" value="Log Out">
                    </form>
                <?php else: ?>
                    <a href="<?php echo e(route('loginPage')); ?>"><button class="btn btn-primary">Log In/Create
                            Account</button></a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <a class="btn btn-link" href="<?php echo e(route('contactPage')); ?>">Contact Us</a>
...
<?php /**PATH C:\xampp\htdocs\eduWeb\resources\views/guest/layouts/master.blade.php ENDPATH**/ ?>