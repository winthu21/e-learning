        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?php echo e(route('userHome')); ?>">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <?php $__currentLoopData = $course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a class="dropdown-item" href="#"><?php echo e($item->course_name); ?></a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('userAbout')); ?>">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Contact</a>
                    </li>
                </ul>
                <p class="p-2 mt-2"><?php echo e(auth()->user()->name); ?></p>
...
<?php /**PATH C:\xampp\htdocs\eduWeb\resources\views/user/layouts/master.blade.php ENDPATH**/ ?>