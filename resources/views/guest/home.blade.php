    ...
    <div id="carouselExampleInterval" class="carousel slide fadeInUp" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                <img src="{{ asset('img/1.jpg') }}" class="img-fluid w-100" alt="...">
                    ...
                    <div class="container text-overlay">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <a href="{{ route('about') }}" class="btn btn-primary py-md-3 px-md-5 me-3 slideInUp">About Us</a>
                                @if (auth()->user() != null)
                                    <a href="{{ route('coursePage') }}" class="btn btn-light py-md-3 px-md-5 slideInUp">Join Courses</a>
                                @else
                                    <a href="{{ route('loginPage') }}" class="btn btn-light py-md-3 px-md-5 slideInUp">Join Now</a>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="carousel-item" data-bs-interval="2000">
                <img src="{{ asset('img/2.jpg') }}" class="img-fluid w-100" alt="...">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
            ...
            <div class="carousel-item">
                <img src="{{ asset('img/3.jpg') }}" class="img-fluid w-100" alt="...">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
